...
const themeConfig: VdoingThemeConfig['themeConfig'] = {
    ...
    footer: {
      ...
      copyrightInfo:
        'zhengwenfeng | <a href="https://github.com/tenqaz/tenqaz.github.io/master/LICENSE" target="_blank">MIT License</a> | <a href="https://beian.miit.gov.cn" target="_blank">赣ICP备2025055428号</a>', // 博客版权信息、备案信息等，支持a标签或换行标签</br>
    },
